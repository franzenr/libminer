...
#' your machine
#' @param sizes A logical value indicating whether to calculate library sizes.
#'  Default `FALSE`
#'
#' @return A `data.frame` containing the count of packages in each
#'  of the user's libraries. If `sizes = TRUE`, a column of library sizes will be added.
#' @export
#'
#' @examples
#' lib_summary()
